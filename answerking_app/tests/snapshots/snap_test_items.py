...
snapshots[
    "PostTests::test_post_invalid_data_returns_bad_request_3_invalid_calories_json 1"
] = {
    "detail": "Validation Error",
...
snapshots[
    "PostTests::test_post_invalid_data_returns_bad_request_4_invalid_description_json 1"
] = {
    "detail": "Validation Error",
    "errors": {
        "description": [
...
snapshots[
    "PostTests::test_post_invalid_data_returns_bad_request_6_invalid_stock_json 1"
] = {
    "detail": "Validation Error",
...
snapshots[
    "PostTests::test_post_invalid_data_returns_bad_request_7_invalid_missing_fields_1_json 1"
] = {
    "detail": "Validation Error",
    "errors": {
...
snapshots[
    "PostTests::test_post_invalid_data_returns_bad_request_8_invalid_missing_fields_2_json 1"
] = {
    "detail": "Validation Error",
    "errors": {
...
snapshots[
    "PostTests::test_post_invalid_data_returns_bad_request_9_invalid_missing_fields_3_json 1"
] = {
    "detail": "Validation Error",
...
snapshots[
    "PutTests::test_put_invalid_data_returns_bad_request_3_invalid_calories_json 1"
] = {
    "detail": "Validation Error",
    "errors": {"calories": ["A valid integer is required."]},
    "status": 400,
...
snapshots[
    "PutTests::test_put_invalid_data_returns_bad_request_4_invalid_description_json 1"
] = {
    "detail": "Validation Error",
    "errors": {
        "description": [
...
snapshots[
    "PutTests::test_put_invalid_data_returns_bad_request_5_invalid_retired_json 1"
] = {
    "detail": "Validation Error",
    "errors": {"retired": ["Must be a valid boolean."]},
    "status": 400,
...
snapshots[
    "PutTests::test_put_invalid_data_returns_bad_request_6_invalid_stock_json 1"
] = {
    "detail": "Validation Error",
    "errors": {"stock": ["A valid integer is required."]},
    "status": 400,
...
snapshots[
    "PutTests::test_put_invalid_data_returns_bad_request_7_invalid_missing_fields_1_json 1"
] = {
    "detail": "Validation Error",
    "errors": {
        "name": ["This field is required."],
...
snapshots[
    "PutTests::test_put_invalid_data_returns_bad_request_8_invalid_missing_fields_2_json 1"
] = {
    "detail": "Validation Error",
    "errors": {
        "description": ["This field is required."],
...
snapshots[
    "PutTests::test_put_invalid_data_returns_bad_request_9_invalid_missing_fields_3_json 1"
] = {
    "detail": "Validation Error",
    "errors": {"calories": ["This field is required."]},
    "status": 400,
