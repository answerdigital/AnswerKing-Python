...
snapshots[
    "PutTests::test_put_invalid_data_returns_bad_request_4_invalid_retired_json 1"
] = {
    "detail": "Validation Error",
    "errors": {"retired": ["Must be a valid boolean."]},
    "status": 400,
...
snapshots[
    "PutTests::test_put_invalid_data_returns_bad_request_5_invalid_missing_fields_1_json 1"
] = {
    "detail": "Validation Error",
    "errors": {
        "name": ["This field is required."],
