...
snapshots[
    ...
    {
        "categories": [],
        "description": "200 chars - Lorem ipsum dolor sit amet, consectetur adipiscing elit. "
        "Duis lacinia dui et nunc hendrerit ullamcorper. Duis sit amet magna "
        "ac velit auctor porta. Praesent viverra vulputate lectus, a ves",
        "id": 3,
        "name": "Chips",
        "price": 1.5,
        "retired": False,
...
snapshots[
    "PostTests::test_post_invalid_data_returns_bad_request_5_invalid_missing_fields_1_json 1"
] = {
    "detail": "Validation Error",
    "errors": {
...
snapshots[
    "PostTests::test_post_invalid_data_returns_bad_request_6_invalid_missing_fields_2_json 1"
] = {
    "detail": "Validation Error",
    "errors": {
...
snapshots[
    ...
    {
        "categories": [],
        "description": "twohundred chars Lorem ipsum dolor sit amet consectetur adipiscing"
        " elit Duis lacinia dui et nunc hendrerit ullamcorper Duis sit amet"
        " magna ac velit auctor porta Praesent viverra vulputate lectusjaue",
        "id": 1,
        "name": "Burger",
        "price": 1.2,
        "retired": False,
...
snapshots[
    "PutTests::test_put_invalid_data_returns_bad_request_6_invalid_missing_fields_2_json 1"
] = {
    "detail": "Validation Error",
    "errors": {
        "description": ["This field is required."],
