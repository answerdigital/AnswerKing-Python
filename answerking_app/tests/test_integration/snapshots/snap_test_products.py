...
snapshots['GetTests::test_get_all_with_products_returns_ok_1_basic_3_json 1'] = [
    {
        'category': None,
        'description': 'desc',
        'id': 1,
...
snapshots['GetTests::test_get_all_with_products_returns_ok_2_basic_1_list_json 1'] = [
    {
        'category': None,
        'description': 'desc',
        'id': 1,
...
snapshots['GetTests::test_get_all_with_products_returns_ok_3_extreme_5_json 1'] = [
    {
        'category': None,
        'description': 'desc',
        'id': 1,
...
snapshots['PostTests::test_post_invalid_data_returns_bad_request_4_invalid_retired_json 1'] = {
    'detail': 'Validation Error',
    'errors': {
        'retired': [
...
snapshots['PostTests::test_post_invalid_data_returns_bad_request_5_invalid_missing_fields_1_json 1'] = {
    'detail': 'Validation Error',
    'errors': {
        'name': [
...
snapshots['PostTests::test_post_invalid_data_returns_bad_request_6_invalid_missing_fields_2_json 1'] = {
    'detail': 'Validation Error',
    'errors': {
        'description': [
            'This field is required.'
...
snapshots['PostTests::test_post_invalid_with_invalid_cat_id_returns_bad_request_1_invalid_category_id_json 1'] = {
    'detail': 'Validation Error',
    'errors': {
        'categoryId': [
...
snapshots['PostTests::test_post_valid_returns_ok_3_boundry_description_json 1'] = [
    {
        'category': None,
...
snapshots['PostTests::test_post_valid_with_cat_id_returns_ok_1_basic_1_with_category_id_json 1'] = [
    {
        'category': {
            'description': 'Juicy Burgers',
            'id': 1,
...
snapshots['PutTests::test_put_invalid_data_returns_bad_request_4_invalid_retired_json 1'] = {
    'detail': 'Validation Error',
    'errors': {
        'retired': [
            'Must be a valid boolean.'
...
snapshots['PutTests::test_put_invalid_data_returns_bad_request_5_invalid_missing_fields_1_json 1'] = {
    'detail': 'Validation Error',
    'errors': {
        'name': [
            'This field is required.'
...
snapshots['PutTests::test_put_invalid_data_returns_bad_request_6_invalid_missing_fields_2_json 1'] = {
    'detail': 'Validation Error',
    'errors': {
        'description': [
            'This field is required.'
...
snapshots['PutTests::test_put_valid_returns_ok_3_boundry_description_json 1'] = [
    {
        'category': None,
        'description': 'twohundred chars Lorem ipsum dolor sit amet consectetur adipiscing elit Duis lacinia dui et nunc hendrerit ullamcorper Duis sit amet magna ac velit auctor porta Praesent viverra vulputate lectusjaue',
        'id': 1,
