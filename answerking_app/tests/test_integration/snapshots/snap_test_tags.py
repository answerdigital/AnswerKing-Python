...
snapshots[
    "PostTests::test_post_invalid_data_returns_bad_request_4_invalid_missing"
    "_fields_json 1"
] = {
    "detail": "Validation Error",
...
snapshots[
    "PostTests::test_post_invalid_data_returns_bad_request_5_invalid_retired"
    "_json 1"
] = {
    "detail": "Validation Error",
...
snapshots[
    "PostTests::test_post_valid_with_products_returns_ok_1_basic_1_with_"
    "products_json 1"
] = [
    {
        "description": "Tag identifying a product as halal.",
...
snapshots[
    "PutTests::test_put_invalid_data_returns_bad_request_4_invalid_missing"
    "_fields_json 1"
] = {
    "detail": "Validation Error",
    "errors": {"name": ["This field is required."]},
...
snapshots[
    "PutTests::test_put_invalid_prod_data_returns_bad_request_1_basic_1_"
    "update_with_products_json 1"
] = {
    "detail": "Validation Error",
...
snapshots[
    "PutTests::test_put_invalid_prod_data_returns_bad_request_2_invalid_"
    "product_id_json 1"
] = {
    "detail": "Validation Error",
    "errors": {
...
snapshots[
    "PutTests::test_put_with_prods_valid_returns_ok_1_basic_1_update_with"
    "_products_json 1"
] = [
    {
        "description": "Tag identifying a product as halal.",
