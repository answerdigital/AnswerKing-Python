...
snapshots["DeleteTests::test_delete_returns_ok 1"] = {
    "createdOn": "2023-02-10T10:26:33.416647Z",
    "id": 1,
    "lastUpdated": "2023-02-10T10:26:33.421672Z",
    "lineItems": [],
...
snapshots[
    ...
    "status": 400,
    "title": "Invalid input.",
    "traceId": "dc377921-9f07-4525-bb8c-e6d4778dc38f",
    "type": "http://testserver/problems/error/",
}

snapshots[
    "PostTests::test_post_invalid_data_returns_bad_request_2_invalid_product_id_json 1"
] = {
    "detail": "Validation Error",
    "errors": {
    ...
    "status": 400,
    "title": "Invalid input.",
    "traceId": "6bc77f4c-f93d-4682-8d75-58ddceead992",
    "type": "http://testserver/problems/error/",
}
...
snapshots[
    ...
    "status": 400,
    "title": "Invalid input.",
    "traceId": "c617d79f-2acc-4a48-988c-4bbf5a5fdf0f",
    "type": "http://testserver/problems/error/",
}
...
snapshots[
    ...
    "status": 400,
    "title": "Invalid input.",
    "traceId": "3ebf685c-43b4-4fd4-b98e-e1a1d9e5d55b",
    "type": "http://testserver/problems/error/",
}
...
snapshots[
    "PutTests::test_put_invalid_products_return_bad_request_1_invalid_missing_quantity_json 1"
] = {
    "detail": "Validation Error",
    "errors": {"lineItems": [{"quantity": ["This field is required."]}]},
    "status": 400,
    "title": "Invalid input.",
    "traceId": "c637788f-c656-46f2-8096-467d2a2859f0",
    "type": "http://testserver/problems/error/",
}

snapshots[
    "PutTests::test_put_invalid_products_return_bad_request_2_invalid_product_id_json 1"
] = {
    "detail": "Validation Error",
    "errors": {
        "lineItems": [{"product": {"id": ["A valid integer is required."]}}]
    ...
    "status": 400,
    "title": "Invalid input.",
    "traceId": "1ec12a17-0597-48a2-9c13-70ba8b70dc8a",
    "type": "http://testserver/problems/error/",
}
...
snapshots[
    ...
    "status": 400,
    "title": "Invalid input.",
    "traceId": "996b4bf1-808b-441c-9d98-0d0abca61825",
    "type": "http://testserver/problems/error/",
}
...
snapshots[
    ...
    "status": 400,
    "title": "Invalid input.",
    "traceId": "b29ee967-2ab9-4c91-adcb-2a3bd320a4ac",
    "type": "http://testserver/problems/error/",
}
...
snapshots[
    "PutTests::test_put_update_quantity_to_zero_return_empty_line_items 1"
] = {
    "createdOn": "2022-04-01T04:02:03.000000Z",
    "id": 2,
    "lastUpdated": "2022-04-01T04:02:03.000000Z",
